    ...
    PLAY(4) {
        {
            ...
            serverBound.register(PacketPlayerPosition::new,
            ...
            clientBound.register(PacketSynchronizePlayerPositionAndLook::new,
